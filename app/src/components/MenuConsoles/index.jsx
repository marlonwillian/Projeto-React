...
import styles from "./MenuConsoles.module.css";

function MenuConsoles( { animation } ) {
    return (
        <nav className={styles.consoles} style={{ animation: animation }}>
